...
export function snapshotRect<T extends MotionRect>(rect: T | null | undefined) {
  if (!rect) return null;
...
export function rectIntersectsViewport(rect: MotionRect | null | undefined, viewport: { width: number; height: number } | null | undefined) {
...
export function folderPanelMotion(originRect: MotionRect | null | undefined, panelRect: MotionRect | null | undefined) {
