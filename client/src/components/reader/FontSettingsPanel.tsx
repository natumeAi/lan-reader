...
import type { FontOption } from '../../hooks/useReaderSettings.js';
export interface FontSettingsPanelProps {
  fontFamilyId: string; fontFamilyOptions: FontOption[]; fontSize: number; fontSizeMax: number; fontSizeMin: number; fontSizeStep: number;
  onDecreaseFontSize: () => void; onIncreaseFontSize: () => void; onFontFamilyChange: (id: string) => void; onFontSizeChange: (event: ChangeEvent<HTMLInputElement>) => void; readerFont: FontOption;
}
